...
CREATE TABLE `challenge_submissions` (
  ...
  `photo_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exif_timestamp` timestamp NULL DEFAULT NULL,
  `exif_lat` decimal(10,7) DEFAULT NULL,
  `exif_lng` decimal(10,7) DEFAULT NULL,
  `status` enum('pending_admin','verified','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_admin',
