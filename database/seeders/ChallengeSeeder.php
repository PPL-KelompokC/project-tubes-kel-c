    ...
    public function run(): void
    {
        ...
        $challenges = [
            ...
            [
                ...
                'ai_keywords'  => ['bicycle', 'bike', 'cycling', 'helmet', 'road', 'pedal'],
                'is_daily'     => true,
                'active_date'  => $today,
            ],
            [
                ...
                'ai_keywords'  => ['vegetables', 'salad', 'plant-based', 'vegan', 'fruits', 'grains', 'cooking'],
                'is_daily'     => true,
                'active_date'  => $today,
            ],
            [
                ...
                'ai_keywords'  => ['recycling bin', 'plastic bottle', 'cardboard', 'cans', 'sorting', 'waste', 'recycle'],
                'is_daily'     => true,
                'active_date'  => $today,
            ],
            ...
            [
                ...
                'ai_keywords'  => ['bus', 'train', 'subway', 'MRT', 'public transport', 'station', 'platform'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
            [
                ...
                'ai_keywords'  => ['reusable bag', 'tote bag', 'shopping', 'grocery', 'cloth bag'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
            [
                ...
                'ai_keywords'  => ['solar panel', 'solar charger', 'portable charger', 'renewable energy', 'sunlight'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
            [
                ...
                'ai_keywords'  => ['seedling', 'plant', 'sapling', 'soil', 'pot', 'garden', 'planting'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
            [
                ...
                'ai_keywords'  => ['vegetarian', 'tofu', 'vegetables', 'legumes', 'salad', 'rice', 'no meat'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
            [
                ...
                'ai_keywords'  => ['washing machine', 'cold wash', 'laundry', 'cold water setting'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
            [
                ...
                'ai_keywords'  => ['lunchbox', 'reusable container', 'bento', 'tiffin', 'no plastic', 'meal prep'],
                'is_daily'     => false,
                'active_date'  => null,
            ],
        ];
